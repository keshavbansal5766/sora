...
const Login = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      {/* left side: Branding */}
      <div className="flex-1 flex flex-col items-start justify-between p-10 md:p-10 lg:pl-40">
        ...
        <div>
          ...
          <h1 className="text-3xl font-bold md:text-6xl md:pb-2 bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent">

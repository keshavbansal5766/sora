          ...
          <form onSubmit={handleSaveProfile} className="space-y-4">
            ...
            <div className="flex justify-end space-x-3 pt-6">
              ...
              type="submit"
                ...
                className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg text-white hover:from-indigo-500 hover:to-purple-700 transition cursor-pointer"
              >
                Save Changes
              </button>
            </div>
